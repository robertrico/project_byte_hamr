...
module iwm (
	...
	// Forward declarations for iverilog (declared fully in synchronizer section)
	reg       q6_meta, q7_meta, q6_sync, q7_sync;
	...
	// q6_meta, q6_sync, q7_meta, q7_sync declared above (forward ref)
