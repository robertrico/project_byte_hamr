 ...
 *   -------  |  ---------- |  -------------- |  ----------
 *   GP2      |  GPIO9      |  rddata          |  Pico → FPGA (PIO TX) [swapped w/ _enbl1]
 ...
 *   GP10     |  GPIO1      |  _enbl1          |  FPGA → Pico [swapped w/ rddata]
...
#define SP_RDDATA       2       /* GP2 OUTPUT — FM data to Apple II (PIO TX) [was GP10, swapped for crosstalk separation] */

/* Handshake */
#define SP_ACK          9       /* GP9 OUTPUT open-drain — active LOW, hi-Z = deasserted */

/* Other signals */
#define SP_ENBL1        10      /* GP10 INPUT — drive 1 enable (active LOW) [was GP2, swapped with rddata] */
