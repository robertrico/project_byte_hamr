 ...
 *   GP10     |  GPIO9      |  rddata          |  Pico → FPGA (PIO TX)
...
#define SP_RDDATA       10      /* GP10 OUTPUT — FM data to Apple II (PIO TX) */

/* Handshake */
#define SP_ACK          9       /* GP9 OUTPUT open-drain — active LOW, hi-Z = deasserted */

/* Other signals */
#define SP_ENBL1        2       /* GP2  INPUT — drive 1 enable (active LOW) */
